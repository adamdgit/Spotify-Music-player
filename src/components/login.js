...
function Login() {
  ...
  const REDIRECT_URI = "https://adamdgit.github.io/spotify"
  ...
  return (
    ...
    !token ?
      <div className="login-wrap">
        ...
        <h1 style={{textAlign: 'center', maxWidth: '800px'}}>If you don't have a Spotify premium account, you can watch the video demo below:</h1>
