    ...
    <header className="header-bar">
      <div className="header-wrap">
        <nav className="nav-bar">
          <NavLink to="/spotify/" ref={nav1} className={(navData) => (navData.isActive ? "nav-item active" : 'nav-item')}>
          ...
          <NavLink to="/spotify/artists" ref={nav2} className={(navData) => (navData.isActive ? "nav-item active" : 'nav-item')}>
          ...
          <NavLink to="/spotify/search" ref={nav3} className={(navData) => (navData.isActive ? "nav-item active" : 'nav-item')}>
