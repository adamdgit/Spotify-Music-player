    ...
    <header className="header-bar">
      <div className="header-wrap">
        <nav className="nav-bar">
          <NavLink to="../library" onClick={() => hidePlaylist()} className={(navData) => (navData.isActive ? "nav-item active" : 'nav-item')}>
          ...
          <NavLink to="/artists" onClick={() => hidePlaylist()} className={(navData) => (navData.isActive ? "nav-item active" : 'nav-item')}>
          ...
          <NavLink to="/search" onClick={() => hidePlaylist()} className={(navData) => (navData.isActive ? "nav-item active" : 'nav-item')}>
