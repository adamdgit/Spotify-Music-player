      ...
      <ul style={devicesAreHidden === true ? {display: 'none'} : {display: 'grid'}}
        ...
        <div className="triangle"></div>
        {
          ...
          devices.map(device => {
            return <li 
            key={device.id} 
            style={currentDeviceID === device.id ? {color: '#23ff73', borderColor: '#23ff73'} : {} }
